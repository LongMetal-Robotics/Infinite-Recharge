...
public class ControlPanel 
{
    ...
    private String currentColor()
    {
        ...
        String colorString;
        ColorMatchResult match = m_colorMatcher.matchClosestColor(detectedColor); //closest color to one from sensor
    ...
    private void spin()
    {
        spinner.set(ControlMode.PercentOutput, Constants.k_SPINRATE);//spins motor at constant speed
    }
    private void stop()
    {
