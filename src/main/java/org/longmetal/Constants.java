...
public class Constants {
    ...
    public static final double GEARBOX_TO_FEET =
            12 / (Math.PI * 7.65); // Convert between rotations of output shaft to feet
    ...
    public static final double MOTOR_TO_FEET =
            GEARBOX_RATIO * GEARBOX_TO_FEET; // The ratio of motor rotations to feet
